# FMP ingestion script for IT COMPANY MARKET CAP
...
BASE_URL = "https://financialmodelingprep.com/stable/market-capitalization"
...
DB_TABLE = "raw_fmp_it_mktcap_daily"
S3_BUCKET = os.getenv("S3_BUCKET")
S3_PREFIX = "smp500_ingestion/fmp_it_mktcap_daily"
...
def upload_df_to_s3(df):
    s3 = boto3.client("s3")
    file_name = f"fmp_it_mktcap_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.csv"
