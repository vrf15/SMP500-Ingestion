# FMP ingestion script for COMS COMPANIES
...
DB_TABLE = "raw_fmp_coms_prices_daily"
S3_BUCKET = os.getenv("S3_BUCKET")
S3_PREFIX = "smp500_ingestion/fmp_coms_prices_daily"
...
def upload_csv_to_s3(csv_body):
    s3 = boto3.client("s3")
    file_name = f"fmp_coms_prices_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.csv"
