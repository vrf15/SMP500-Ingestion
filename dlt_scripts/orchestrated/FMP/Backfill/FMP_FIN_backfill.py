# FMP backfill script for FIN COMPANIES
...
DB_TABLE = "raw_fmp_fin_prices_backfill"
S3_BUCKET = os.getenv("S3_BUCKET")
S3_PREFIX = "smp500_ingestion/fmp_fin_prices_backfill"
...
def upload_csv_to_s3(csv_body, chunk_number):
    s3 = boto3.client("s3")
    file_name = f"fmp_fin_backfill_chunk{chunk_number:03d}_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.csv"
