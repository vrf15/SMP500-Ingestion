# TNGO ingestion script for BATCH 3
...
DB_TABLE = "raw_tngo_batch3_prices_daily"
S3_BUCKET = os.getenv("S3_BUCKET")
S3_PREFIX = "smp500_ingestion/tngo_batch3_prices_daily"
...
def upload_csv_to_s3(csv_body):
    s3 = boto3.client("s3")
    file_name = f"tngo_batch3_prices_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.csv"
