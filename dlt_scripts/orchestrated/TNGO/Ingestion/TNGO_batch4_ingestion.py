# TNGO ingestion script for BATCH 4
...
TICKER_FILE = Path("/opt/airflow/config/smp500_ingestion/TNGO_SP500_BATCH4_ticker.txt")
...
DB_TABLE = "raw_tngo_batch4_prices_daily"
S3_BUCKET = os.getenv("S3_BUCKET")
S3_PREFIX = "smp500_ingestion/tngo_batch4_prices_daily"
...
def upload_csv_to_s3(csv_body):
    s3 = boto3.client("s3")
    file_name = f"tngo_batch4_prices_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.csv"
