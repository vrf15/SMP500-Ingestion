...
# Fetching data with retry logic... free cannot use start/end date (REMINDER: THIS IS AN API CONFIGURATION)
...
# Uploading to RDBMS — chunked to avoid memory spikes on large payloads, quoted column names
