# Daily TNGO Batch 1 Ingestion Orchestrator
...
with DAG(
    dag_id="smp500_tngo_batch1_ingestion_dag",
    ...
    schedule="45 17 * * 1-5",
    catchup=False,
    tags=["smp500", "tngo", "batch1", "ingestion"],
) as dag:
    run_tngo_batch1_ingestion = BashOperator(
        task_id="run_tngo_batch1_ingestion",
        bash_command=(
            "cd /opt/airflow/dlt_scripts/smp500_ingestion && "
            "python TNGO_batch1_ingestion.py"
        ),
    )

    run_tngo_batch1_ingestion